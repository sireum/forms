...
public class HAMRCodeGenForm {
    ...
    public JPanel camkesMicrokitPanel;
    ...
    public JLabel sel4AuxCodeDirLabel;
    public JTextField sel4AuxCodeDirs;
    public JTextField sel4OutputDir;
    public JButton seL4OutputBrowseButton;
    public JButton sel4AuxCodeDirsBrowseButton;
    ...
    public JCheckBox verusAttributeSyntax;
    public JCheckBox sel4AuxCodeSymlink;
    public JComboBox scheduling;
    public JLabel schedulingLabel;
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        defaultComboBoxModel1.addElement("Microkit");
        ...
        headerPanel.add(runtimeMonitoring, new GridConstraints(2, 0, 1, 2, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        camkesMicrokitPanel = new JPanel();
        camkesMicrokitPanel.setLayout(new GridLayoutManager(5, 4, new Insets(0, 0, 0, 0), -1, -1));
        codegenPanel.add(camkesMicrokitPanel, new GridConstraints(3, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        camkesMicrokitPanel.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "CAmkES/Microkit Options", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
        seL4OutputLabel = new JLabel();
        seL4OutputLabel.setText("seL4 Output Directory");
        camkesMicrokitPanel.add(seL4OutputLabel, new GridConstraints(2, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(180, 17), null, 0, false));
        sel4AuxCodeDirLabel = new JLabel();
        sel4AuxCodeDirLabel.setText("Aux Code Directory for seL4");
        camkesMicrokitPanel.add(sel4AuxCodeDirLabel, new GridConstraints(3, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(180, 17), null, 0, false));
        sel4AuxCodeDirs = new JTextField();
        camkesMicrokitPanel.add(sel4AuxCodeDirs, new GridConstraints(3, 1, 1, 2, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
        seL4OutputBrowseButton = new JButton();
        seL4OutputBrowseButton.setText("...");
        camkesMicrokitPanel.add(seL4OutputBrowseButton, new GridConstraints(2, 3, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, 1, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        sel4AuxCodeDirsBrowseButton = new JButton();
        sel4AuxCodeDirsBrowseButton.setText("...");
        camkesMicrokitPanel.add(sel4AuxCodeDirsBrowseButton, new GridConstraints(3, 3, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, 1, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        sel4OutputDir = new JTextField();
        camkesMicrokitPanel.add(sel4OutputDir, new GridConstraints(2, 1, 1, 2, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
        verusAttributeSyntax = new JCheckBox();
        verusAttributeSyntax.setText("Verus Attribute Syntax");
        camkesMicrokitPanel.add(verusAttributeSyntax, new GridConstraints(0, 0, 1, 3, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        sel4AuxCodeSymlink = new JCheckBox();
        sel4AuxCodeSymlink.setText("seL4 Aux Code Sym Link");
        camkesMicrokitPanel.add(sel4AuxCodeSymlink, new GridConstraints(4, 0, 1, 3, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        schedulingLabel = new JLabel();
        schedulingLabel.setText("Scheduling");
        camkesMicrokitPanel.add(schedulingLabel, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        scheduling = new JComboBox();
        final DefaultComboBoxModel defaultComboBoxModel3 = new DefaultComboBoxModel();
        defaultComboBoxModel3.addElement("Domain");
        defaultComboBoxModel3.addElement("UserLand");
        scheduling.setModel(defaultComboBoxModel3);
        camkesMicrokitPanel.add(scheduling, new GridConstraints(1, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final Spacer spacer5 = new Spacer();
        camkesMicrokitPanel.add(spacer5, new GridConstraints(1, 2, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
        ...
        bottomPanel.add(spacer6, new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
        ...
        defaultComboBoxModel4.addElement("Xml");
        ros2LaunchLanguage.setModel(defaultComboBoxModel4);
        ...
        ros2OptionsPanel.add(spacer7, new GridConstraints(2, 2, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
        ros2NodesLanguage = new JComboBox();
        final DefaultComboBoxModel defaultComboBoxModel5 = new DefaultComboBoxModel();
        defaultComboBoxModel5.addElement("Cpp");
        defaultComboBoxModel5.addElement("Python");
        ros2NodesLanguage.setModel(defaultComboBoxModel5);
        ...
        slangOptionsPanel.setLayout(new GridLayoutManager(2, 3, new Insets(0, 0, 0, 0), -1, -1));
        ...
        slangOptionsPanel.add(packageName, new GridConstraints(1, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
        slangBasePackageNameLabel = new JLabel();
        slangBasePackageNameLabel.setText("Base Package Name");
        slangOptionsPanel.add(slangBasePackageNameLabel, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        slangOutputDirectoryLabel = new JLabel();
        slangOutputDirectoryLabel.setText("Slang Output Directory");
        slangOptionsPanel.add(slangOutputDirectoryLabel, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        slangOutputDir = new JTextField();
        slangOptionsPanel.add(slangOutputDir, new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
        slangOutputDirectoryButton = new JButton();
        slangOutputDirectoryButton.setText("...");
        slangOptionsPanel.add(slangOutputDirectoryButton, new GridConstraints(0, 2, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
    }
