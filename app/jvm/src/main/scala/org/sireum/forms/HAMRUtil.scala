...
// Autogenerated via $SIREUM_HOME/hamr/codegen/bin/scripts/formBuilder.cmd
  ...
  def decaseScheduling(e: Cli.SireumHamrSysmlCodegenScheduling.Type): Predef.String = {
    e match {
      case Cli.SireumHamrSysmlCodegenScheduling.Domain => "Domain"
      case Cli.SireumHamrSysmlCodegenScheduling.UserLand => "UserLand"
    }
  }
  ...
  def buildHamrOptionStore(o: Cli.SireumHamrSysmlCodegenOption): HAMRCodeGenFormEx.CodegenOptionStore = {
    ...
    store.scheduling = decaseScheduling(o.scheduling)
    store.verusAttributeSyntax = o.verusAttributeSyntax
    ...
    store.sel4AuxCodeSymlink = o.sel4AuxCodeSymlink
